...
from keras.layers import Input, concatenate, Conv2D, Dense, MaxPooling2D, UpSampling2D, BatchNormalization, LeakyReLU, Add
...
def create_unet_512x512(input_shape=(512, 512, 1), pooling_mode='avg',
    ...
    down0a = LeakyReLU(alpha=0.3)(down0a)
    ...
    down0 = LeakyReLU(alpha=0.3)(down0)
    ...
    down1 = LeakyReLU(alpha=0.3)(down1)
    down1_pool = MaxPooling2D((2, 2), strides=(2, 2))(down1)
    # 64x64x64

    down2 = Conv2D(128, (3, 3), padding='same')(down1_pool)
    down2 = BatchNormalization()(down2)
    down2 = LeakyReLU(alpha=0.3)(down2)
    down2_pool = MaxPooling2D((2, 2), strides=(2, 2))(down2)
    # 32x32x128

    down3 = Conv2D(256, (3, 3), padding='same')(down2_pool)
    down3 = BatchNormalization()(down3)
    down3 = LeakyReLU(alpha=0.3)(down3)
    down3_pool = MaxPooling2D((2, 2), strides=(2, 2))(down3)
    # 16x16x256

    down4 = Conv2D(512, (3, 3), padding='same')(down3_pool)
    down4 = BatchNormalization()(down4)
    down4 = LeakyReLU(alpha=0.3)(down4)
    ...
    ep3 = LeakyReLU(alpha=0.3)(ep3)

    ep2 = Dense(512)(ep3)
    ep2 = BatchNormalization()(ep2)
    ep2 = LeakyReLU(alpha=0.3)(ep2)

    ep1 = Dense(256)(ep2)
    ep1 = BatchNormalization()(ep1)
    ep1 = LeakyReLU(alpha=0.3)(ep1)
...
# \brief Symmetric Unet for shapes 800,540 with minimized numbers of parameter
#
def create_unet_min_135x200(input_shape=(135, 200, 1), pooling_mode='avg',
                            num_classes=1):
    # ##########
    inputs = Input(shape=input_shape)
    # ##########
    ...
    down0_pool = MaxPooling2D((2, 2), strides=(3, 2))(down0)
    # ##########
    # 45x100x32
    # ##########
    down1 = Conv2D(64, (3, 3), padding='same')(down0_pool)
    ...
    down1 = BatchNormalization()(down1)
    down1 = LeakyReLU(alpha=0.3)(down1)
    down1_pool = MaxPooling2D((2, 2), strides=(3, 2))(down1)
    # ##########
    # 15x50x128
    # ##########
    down2 = Conv2D(256, (3, 3), padding='same')(down1_pool)
    ...
    # ##########
    segmentation = Conv2D(num_classes, (1, 1), activation='softmax', bias_initializer='zeros')(up0)
    # Output layer (segmentation) -> 135x200x1
...
def get_unet(model_name='unet_opt_512x512', input_shape=(512, 512, 1), pooling_mode='avg', num_classes=1, lr=0.01):
    ...
    parallel_model.compile(loss='mse', loss_weights=[0.6, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.15], optimizer=optimizer, metrics=['mse'])

...
def get_unet_512(input_shape=(512, 512, 3),
    ...
    try:
        model = multi_gpu_model(model=model, cpu_relocation=True)
...
def get_advanced_unet_512(input_shape=(512, 512, 3),
    ...
    hc4 = Flatten()(center)
    hc3 = Dense(128, activation='relu')(hc4)
    hc2 = Dense(512, activation='relu')(hc3)
    hc1 = Dense(256, activation='relu')(hc2)
    hc0 = Dense(1, activation='softmax')(hc1)
    # Output (head circumference) -> 1

    # build model with two outputs
    model = Model(inputs=inputs, outputs=[segmentation, hc0])

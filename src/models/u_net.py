...
# ===========================================================================
# \brief Symmetric Unet sfor shapes 512,512 with two outputs
#
def get_advanced_unet_512(input_shape=(512, 512, 3),
				 num_classes=1):
	inputs = Input(shape=input_shape)
	# 512
    ...
    # hc4 = Dense(512, (3, 3), padding='same')(center)
    # hc4 = BatchNormalization()(hc4)
    # hc4 = Activation('relu')(hc4)
    # hc4 = Conv2D(512, (3, 3), padding='same')(hc4)
    # hc4 = BatchNormalization()(hc4)
    # hc4 = Activation('relu')(hc4)
    # hc4 = Conv2D(512, (3, 3), padding='same')(hc4)
    # hc4 = BatchNormalization()(hc4)
